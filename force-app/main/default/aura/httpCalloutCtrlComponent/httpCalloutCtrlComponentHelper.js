({
    getResponse: function(component, base) {
        ...
        action.setParams({
            "url":'https://th-apex-http-callout.herokuapp.com/animals' +base
        });
